...
jhu_url1 <- paste0(repopath, "time_series_19-covid-Confirmed.csv")
jhu_url2 <- paste0(repopath, "time_series_19-covid-Deaths.csv")
jhu_url3 <- paste0(repopath, "time_series_19-covid-Recovered.csv")
...
readdatadata <- eventReactive(input$loaddata,
                              {
                                withProgress(value = NULL, {
                                  ...
                                  download.file(jhu_url1, path1)
                                  download.file(jhu_url2, path2)
                                  download.file(jhu_url3, path3)
